// Seleção pelo ID do título
const title = document.getElementById("titulo");

// Seleção do botão que exibe "Hello"
const helloBtn = document.getElementById("botao-ola");

// Seleção do botão que altera o título
...
botaoDeMudarAsFrases.addEventListener('click', function(){
  for (let i = 0; i <mensagens.length; i++) {
    mensagens[i].textContent = Aqui está  a frase modificada ${i + 1} utilizando JS
  }
})